...
stackbarchart_df['Unrecovered'] = stackbarchart_df['Confirmed'] - \
                                  stackbarchart_df['Deaths'] - stackbarchart_df['Recovered']
...
trace1_stackbarchart = go.Bar(x=stackbarchart_df['Country'], y=stackbarchart_df['Unrecovered'],
                              name='Under Treatment', marker={'color': '#CD7F32'})
trace2_stackbarchart = go.Bar(x=stackbarchart_df['Country'], y=stackbarchart_df['Recovered'],
                              name='Recovered', marker={'color': '#9EA0A1'})
trace3_stackbarchart = go.Bar(x=stackbarchart_df['Confirmed'], y=stackbarchart_df['Deaths'], name='Deaths', marker={'color': '#FFD700'})
...
trace3_multiline = go.Scatter(x=multiline_df['Date'], y=multiline_df['Unrecovered'],
                              mode='lines', name='Under Treatment')
...
app.layout = html.Div(children=[
    ...
    html.Div('This bar chart represents the number of confirmed cases in the first 20'
             'countries of selected continent.'),
    dcc.Graph(id='graph1'),
    ...
    html.Div('THis bar chart represents the number of confirmed cases in the fires 20'
             'states of the US'),
    dcc.Graph(id='graph2',
              figure={
                  'data': data_barchart,
    ...
    html.Div('This stack bat chart represents the CoronaVirus deaths, recovered and under treatment'
             'of all reported first 20 countries except China'),
    dcc.Graph(id='graph3',
              figure={
                  'data': data_stackbarchart,
                  'layout': go.Layout(title='Corona Virus Cases in the first 20 countires except China',
                                      xaxis={'title': 'Country'}, yaxis={'title': 'Number of Cases'},
                                      barmode='stack')
              }),
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Line Chart', style={'color': '#DF1E56'}),
    html.Div('This line chart represents the Corona Virus confirmed cases of all'
             'reported cases in the given period.'),
    dcc.Graph(id='graph4',
              figure={
                  'data': data_linechart,
                  'layout': go.Layout(title='Corona Virus Confirmed Cases from 1/22/2020 to 3/17/2020',
                                      xaxis={'title': 'Date'}, yaxis={'title': 'Number of cases'})
              }),
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Multi Line Chart', style={'color': '#DF1E56'}),
    html.Div('This line chart represents the CoronaVirus death, recovered and under treatment cases'
             'of all reported cases in the given period.'),
    dcc.Graph(id='graph5',
              figure={
                  'data': data_multiline,
                  'layout': go.Layout(title='Corona Virus Death, Recovered, and Under Treatment'
                                            'from 1/22/2020 to 3/17/2020',
                                      xaxis={'title': 'Date'}, yaxis={'title': 'Number of cases'})
              }),
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Bubble chart', style={'color': '#DF1E56'}),
    html.Div('This bubble chart represents the CoronaVirus recovered and under treatment'
             'of all reported cases from countries except China'),
    dcc.Graph(id='graph6',
              figure={
    ...
    html.Div('This heat map represents the CoronaVirus recorded cases of all reported'
...
def update_figure(selected_continent):
    ...
    return {'data': data_interactive_barchart, 'layout': go.Layout(title='Corona Virus Confirmed Cases in'+selected_continent,
            xaxis={'title': 'Country'}, yaxis={'title': 'Number of confirmed cases'})}
